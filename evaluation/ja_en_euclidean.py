...
ass = KFoldAssessment(5, 'ja_en_euclidean', parameter_ranges, num_configs=100)
...
data = GraphMatchingDataset('ja_en', data.x1, data.edge_index1, None, data.x2, data.edge_index2, None, gt)
